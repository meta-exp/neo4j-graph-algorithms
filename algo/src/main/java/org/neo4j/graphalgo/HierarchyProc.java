...
public class HierarchyProc {
    ...
    @Description("algo.multiTypes(startNodeId:Number, maxDepth:Number, edgeType:String, nameProperty:String, typeLabel:String) " +
    ...
    @Description("algo.hierarchySingleNode(nodeId:Number, edgeType:String, nameProperty:String, typeLabel:String) " +
            "YIELD success, executionTime" +
            "- Version 1.0: Creates a type hierarchy around a single node.")
    public Stream<Result> hierarchySingleNode(
        ...
        long startTime = System.currentTimeMillis();
        algo.processNode(nodeId.longValue(),1, 1);
        long executionTime = System.currentTimeMillis() - startTime;
